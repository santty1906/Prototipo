  ...
  return (
    <div className="mx-auto max-w-xl rounded-lg border border-red-200 bg-white p-8">
      ...
      <p className="mt-2 text-sm text-slate-600">
        Usually this means the Supabase connection is not set up yet. Check that{" "}
        <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">.env.local</code> holds a real
        project URL and keys, and that the migrations in{" "}
        <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">supabase/migrations</code> have
        been applied.
      </p>
      {error.message ? (
